...
public class Constant {
     ...
     * dialog对话框类型
     ****************/
    public static final int SHOWCANCELBUTTON = 0; // 只显示取消按钮
    public static final int SHOWCONFIRMBUTTON = 1; // 只显示确定按钮
    ...
    public static final String BABY_HOBBY = "baby_hobby";
    public static final String TOKEN = "token";
    public static final String USER = "user";
    public static final String CITYS = "citys";
    public static final String CITY = "city";
    public static final String NAME = "name";
    public static final String AVATAR_BINARY = "avatar_binary";
    ...
    public static final String SHIPPING_USER = "shipping_user";
    ...
    public static final String STOCK_SURPLUS = "stock_surplus";

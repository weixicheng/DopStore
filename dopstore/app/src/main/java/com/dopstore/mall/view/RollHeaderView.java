...
import com.dopstore.mall.util.DisplayUtil;
...
public class RollHeaderView extends FrameLayout implements OnPageChangeListener {
    ...
    public void setImgUrlData(List<String> urlList) {
        ...
        if (mUrlList != null && !mUrlList.isEmpty()) {
            ...
            for (int i = 0; i < mUrlList.size(); i++) {
                ...
                if (i == 0) {
                    dotIv.setBackgroundResource(R.mipmap.dop_press);
                } else {
                    dotIv.setBackgroundResource(R.mipmap.dop_normal);
                }
                //设置点的间距
    ...
    private class MyAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            ViewGroup.LayoutParams imagePa = new ViewGroup.LayoutParams(
                    screenWidth, picSize);
            iv.setScaleType(ScaleType.CENTER_CROP);
            iv.setLayoutParams(imagePa);
            ...
            //加载图片
            ImageLoader.getInstance().displayImage(mUrlList.get(position % mUrlList.size())+"?imageView2/1/w/1000/h/480", iv);
    ...
    public void onPageSelected(int position) {
        dotList.get(prePosition).setBackgroundResource(R.mipmap.dop_normal);
        dotList.get(position % dotList.size()).setBackgroundResource(R.mipmap.dop_press);

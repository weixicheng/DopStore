package com.dopstore.mall.view.view;
...
public class PullToRefreshView extends RelativeLayout {
	...
	public void addLoadingView() {
		...
		String pullDownLabel ="下拉刷新";
		String refreshingDownLabel = "正在刷新…";
		String releaseDownLabel = "释放更新";
		String pullUpLabel = "上拉查看更多";
		String refreshingUpLabel = "正在加载…";
		String releaseUpLabel = "释放加载更多";
